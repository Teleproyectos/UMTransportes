<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeBehind="ClienteConectividadWebForm.aspx.cs" Async="true" Inherits="UMTransporte.ClienteConectividadWebForm" %>
            ...
            <asp:Table runat="server" GridLines="Both" Height="200px" Width="100%">
                <asp:TableRow runat="server" Height="200px">
                    <asp:TableCell runat="server" Width="400" BorderColor="Gray" BorderWidth="1">
                        <asp:Label Font-Bold="true" runat="server" Text="ORIGEN"></asp:Label><br />
                        <br />
                        ...
                        <asp:Table runat="server">
                            <asp:TableRow runat="server">
                                ...
                                <asp:TableCell runat="server">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="true">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="xRegionOrigen" Width="230" OnSelectedIndexChanged="RegionDropdownList_SelectedIndexChanged" runat="server" AutoPostBack="True" MaintainScrollPositionOnPostback="True" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </asp:TableCell>
                                <asp:TableCell Width="300">
                            ...
                            <asp:TableRow ID="xComunaOrigenContainer" runat="server">
                                <asp:TableCell Width="20" />
                                <asp:TableCell Width="140">
                    ...
                    <asp:TableCell runat="server" Width="400" BorderColor="Gray" BorderWidth="1">
                        <asp:Label Font-Bold="true" runat="server" Text="DESTINO"></asp:Label><br />
                        <br />
                        <asp:Table runat="server">
                            <asp:TableRow runat="server">
                                <asp:TableCell Width="20" />
                        ...
                        <asp:Table runat="server">
                            <asp:TableRow runat="server">
                                ...
                                <asp:TableCell runat="server">
                                    <asp:DropDownList ID="xRegionDestino" Width="230" OnSelectedIndexChanged="RegionDropdownList_SelectedIndexChanged" runat="server" AutoPostBack="True" />
                                </asp:TableCell>
                                <asp:TableCell Width="300">
                                </asp:TableCell>
                            </asp:TableRow>
